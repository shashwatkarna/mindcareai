...
export const metadata = {
  title: "New Journal Entry - MindCare AI",
...
export default async function NewJournalPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-[#3d3d3d]">New Journal Entry</h1>
        <p className="text-[#6b6b6b] mt-1">Express yourself in a safe, private space</p>
      </div>
